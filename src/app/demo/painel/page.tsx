        ...
        {activeTab === 'categorias' && (
          <div>
            ...
            <Link
              ...
              className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-[#10B981] to-[#0D9488] text-white mb-6 hover:shadow-lg transition-all group"
            >
              <div className="flex items-center gap-3">
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-[#8B5CF6] to-[#7C3AED] text-white mb-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {[
                  { icon: '🔔', label: 'Chamados', desc: 'Abrir e acompanhar solicitações', href: '/demo/morador' },
                  { icon: '🏷️', label: 'Classificados', desc: 'Compra, venda e doação', href: '/demo/morador' },
                  { icon: '🚗', label: 'Caronas', desc: 'Oferecer e pedir caronas', href: '/demo/morador' },
                  { icon: '📱', label: 'QR Codes', desc: 'Acessos rápidos do condomínio', href: '/demo/qrcodes' },
                ].map(f => (
                  <Link
                    key={f.label}
                    href={f.href}
            ...
            <div className="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-[#1E3A5F] to-[#2A5A8F] text-white mb-6">
              <div className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center text-xl">📖</div>
              <div>
        ...
        {activeTab === 'config' && (
          <div className="max-w-2xl">
            ...
            <div className="space-y-6">
              ...
              <button className="w-full py-3 bg-gradient-to-r from-[#1E3A5F] to-[#2A5A8F] text-white font-semibold rounded-xl hover:shadow-lg transition-all">
