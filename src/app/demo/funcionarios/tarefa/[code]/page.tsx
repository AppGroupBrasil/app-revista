...
export default function TarefaFuncionarioPage({ params }: { params: Promise<{ code: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F8FAFC] to-[#EEF2FF]">
      ...
      <InstallPrompt show={showInstall} onDismiss={() => setShowInstall(false)} context="tarefa" />
    </div>
  );
}
