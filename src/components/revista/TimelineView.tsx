                  ...
                  >
                    ...
                    {section.images.length > 0 && (
                      <div className="relative w-full h-32 overflow-hidden">
                        <Image src={section.images[0]} alt={section.title} fill className="object-cover group-hover:scale-105 transition-transform" sizes="50vw" unoptimized />
                              ...
                              <div className="grid grid-cols-2 gap-2 mb-3">
                                {section.images.slice(1).map((img, i) => (
                                  <div key={i} className="relative h-28 rounded-lg overflow-hidden">
                                    <Image src={img} alt="" fill className="object-cover" sizes="30vw" unoptimized />
                                  </div>
                                ))}
                              </div>
                            )}
