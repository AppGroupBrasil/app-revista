  ...
  return (
    <div className="p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <div>
          <div className="text-[10px] font-bold text-text">Palavra do Síndico</div>
          <div className="text-[8px] text-text-muted">Carlos Santos · Março 2026</div>
        </div>
      </div>
      ...
      <div className="text-[8px] text-text-muted italic">&ldquo;Transparência e proximidade são nossos pilares.&rdquo;</div>
    </div>
  );
}
...
function MockFinanceiro({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">💰 Prestação de Contas — Fev/2026</div>
      <div className="grid grid-cols-2 gap-2 mb-3">
        {[
          ...
          <div key={i} className="p-2.5 rounded-xl border border-border">
            <div className="text-[8px] text-text-muted">{item.icon} {item.label}</div>
      ...
      <div className="h-20 rounded-xl border border-border p-2 flex items-end gap-1.5 mt-2">
      ...
      <div className="text-[7px] text-text-muted text-center mt-1">Jan — Dez 2026</div>
    </div>
  );
}
...
function MockGaleria({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-1">📸 Galeria de Fotos</div>
      <div className="text-[8px] text-text-muted mb-3">Março 2026 · 12 fotos</div>
        ...
        {[
          ...
          <div key={i} className={`rounded-xl overflow-hidden ${i === 0 ? 'col-span-2 h-24' : 'h-20'}`}
            ...
            <div className="w-full h-full flex flex-col items-center justify-center">
              ...
              <span className="text-[7px] text-text-light mt-0.5">{item.label}</span>
            </div>
          </div>
        ))}
      </div>
...
function MockAntesDepois({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🔄 Antes e Depois</div>
      ...
      <div className="text-[9px] font-bold text-text">Pintura do Hall — Bloco A</div>
      <div className="text-[8px] text-text-muted">Realizado em 10/03/2026 · Zelador José</div>
...
function MockEquipe({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">👥 Nossa Equipe</div>
      {[
        ...
        <div key={i} className="flex items-center gap-3 p-2.5 rounded-xl border border-border mb-2">
          ...
          <div className="flex-1">
            <div className="text-[10px] font-bold text-text">{p.nome}</div>
            <div className="text-[8px] text-text-muted">{p.cargo}</div>
          </div>
...
function MockObras({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🏗️ Obras em Andamento</div>
      {[
        ...
        <div key={i} className="p-3 rounded-xl border border-border mb-2">
          <div className="flex justify-between items-center mb-1">
            <div className="text-[10px] font-bold text-text">{obra.titulo}</div>
          ...
          <div className="text-[7px] text-text-muted">Prazo: {obra.prazo}</div>
        </div>
      ))}
    </div>
  );
...
function MockComunicados({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">📢 Comunicados</div>
      {[
        ...
        <div key={i} className="p-3 rounded-xl border-l-4 bg-surface-alt mb-2" style={{ borderLeftColor: color }}>
          <div className="text-[10px] font-bold text-text">{c.titulo}</div>
          <div className="text-[8px] text-text-light mt-1 leading-relaxed">{c.texto}</div>
          <div className="text-[7px] text-text-muted mt-1.5">{c.tipo} · {c.tempo} atrás</div>
        </div>
      ))}
    </div>
  );
...
function MockEventos({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🎉 Próximos Eventos</div>
      {[
        ...
        <div key={i} className="p-3 rounded-xl border border-border mb-2">
          <div className="flex items-start gap-2.5">
            ...
            <div>
              <div className="text-[10px] font-bold text-text">{ev.nome}</div>
              <div className="text-[8px] text-text-muted">{ev.local}</div>
              <div className="text-[8px] text-text-light mt-0.5">{ev.desc}</div>
            </div>
          </div>
        </div>
      ))}
...
function MockRegras({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">📋 Regras do Condomínio</div>
      {[
        ...
        <div key={i} className="p-2.5 rounded-xl border border-border mb-2">
          <div className="text-[9px] font-bold text-text mb-0.5">{r.titulo}</div>
          <div className="text-[8px] text-text-light leading-relaxed">{r.texto}</div>
        </div>
      ))}
    </div>
  );
...
function MockEspacoKids({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🧸 Espaço Kids</div>
      <div className="p-3 rounded-xl mb-3" style={{ backgroundColor: `${color}10` }}>
        ...
        <div className="text-[8px] text-text-light">Segunda a Sexta: 8h às 20h</div>
        <div className="text-[8px] text-text-light">Sábado e Domingo: 9h às 21h</div>
      </div>
      <div className="text-[9px] font-bold text-text mb-2">Atividades da Semana</div>
      {[
        ...
        <div key={i} className="flex items-center gap-2 p-2 rounded-lg border border-border mb-1.5">
          <span className="text-sm">{a.icon}</span>
          <div>
            <div className="text-[9px] font-bold text-text">{a.ativ}</div>
            <div className="text-[7px] text-text-muted">{a.dia}</div>
          </div>
        </div>
      ))}
...
function MockSustentabilidade({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🌱 Condomínio Verde</div>
      <div className="grid grid-cols-2 gap-2 mb-3">
        {[
          ...
          <div key={i} className="p-2.5 rounded-xl border border-border text-center">
            <div className="text-lg">{m.icon}</div>
            <div className="text-[11px] font-bold" style={{ color }}>{m.valor}</div>
            <div className="text-[7px] text-text-muted">{m.desc}</div>
          </div>
        ))}
      </div>
...
function MockSeguranca({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🔒 Segurança</div>
      ...
      <div className="text-[9px] font-bold text-text mb-2">Novidades</div>
      <div className="text-[8px] text-text-light leading-relaxed mb-2">
...
function MockPets({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🐾 Pets do Condomínio</div>
      <div className="grid grid-cols-2 gap-2 mb-3">
        {[
          ...
          <div key={i} className="rounded-xl border border-border overflow-hidden">
            ...
            <div className="p-2">
              <div className="text-[10px] font-bold text-text">{pet.nome}</div>
              <div className="text-[7px] text-text-muted">{pet.raca} · {pet.apto}</div>
            </div>
          </div>
        ))}
      </div>
      <div className="p-2 rounded-lg text-[8px] text-text-light" style={{ backgroundColor: `${color}08` }}>
...
function MockSaude({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🏥 Saúde e Bem-estar</div>
      {[
        ...
        <div key={i} className="p-2.5 rounded-xl border border-border mb-2">
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <div className="text-[9px] font-bold text-text">{item.titulo}</div>
          </div>
          <div className="text-[8px] text-text-light leading-relaxed">{item.texto}</div>
        </div>
      ))}
    </div>
  );
...
function MockClassificados({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🏷️ Classificados</div>
      <div className="grid grid-cols-2 gap-2">
        {[
          ...
          <div key={i} className="rounded-xl border border-border overflow-hidden">
            ...
            <div className="p-2">
              <div className="text-[9px] font-bold text-text">{item.nome}</div>
              <div className="text-[10px] font-bold" style={{ color }}>{item.preco}</div>
              <div className="text-[7px] text-text-muted">{item.apto} · {item.tipo}</div>
            </div>
          </div>
        ))}
      </div>
...
function MockPublicidade({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">📣 Espaço Publicitário</div>
      {[
        ...
        <div key={i} className="p-3 rounded-xl border border-border mb-2">
          <div className="flex items-center gap-2 mb-1">
            ...
            <div className="text-[10px] font-bold text-text">{ad.nome}</div>
          </div>
          <div className="text-[8px] text-text-light mb-1">{ad.desc}</div>
          <div className="text-[8px] font-bold" style={{ color }}>📞 {ad.tel}</div>
        </div>
      ))}
      <div className="text-[7px] text-center text-text-muted mt-2">Anuncie aqui! Fale com a administração.</div>
    </div>
  );
}
...
function MockPrestadores({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🔧 Prestadores de Serviço</div>
      {[
        ...
        <div key={i} className="flex items-center gap-2.5 p-2.5 rounded-xl border border-border mb-2">
          <div className="w-9 h-9 rounded-lg flex items-center justify-center text-lg" style={{ backgroundColor: `${color}10` }}>{p.icon}</div>
          <div className="flex-1">
            <div className="text-[9px] font-bold text-text">{p.nome}</div>
            <div className="text-[7px] text-text-muted">{p.area} · {p.avaliacao}</div>
          </div>
...
function MockAchadosPerdidos({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🔍 Achados e Perdidos</div>
      <div className="flex gap-2 mb-3">
        ...
        <div className="flex-1 py-1.5 rounded-lg text-center text-[9px] font-bold text-text-light bg-surface-hover">Perdidos (2)</div>
      </div>
      {[
        ...
        <div key={i} className="flex gap-2.5 p-2.5 rounded-xl border border-border mb-2">
          <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${color}10` }}>
            <span className="text-lg">{item.icone}</span>
          </div>
          <div>
            <div className="text-[9px] font-bold text-text">{item.item}</div>
            <div className="text-[8px] text-text-muted">{item.local}</div>
...
function MockEnquetes({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">📊 Enquete do Mês</div>
      <div className="p-3 rounded-xl border border-border mb-3">
        <div className="text-[10px] font-bold text-text mb-2">Qual melhoria priorizar em 2026?</div>
        {[
          ...
          <div key={i} className="mb-1.5">
            <div className="flex justify-between text-[8px] mb-0.5">
              <span className="text-text-light">{opt.opcao}</span>
        ...
        <div className="text-[7px] text-text-muted mt-2">127 votos · Encerra em 5 dias</div>
      </div>
...
function MockDicasSindico({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">💡 Dicas do Síndico</div>
      {[
        ...
        <div key={i} className="p-3 rounded-xl border border-border mb-2">
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <div className="text-[10px] font-bold text-text">{dica.titulo}</div>
          </div>
          <div className="text-[8px] text-text-light leading-relaxed">{dica.texto}</div>
        </div>
      ))}
    </div>
  );
...
function MockEspacoMorador({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🏠 Espaço do Morador</div>
      <div className="p-3 rounded-xl mb-3" style={{ backgroundColor: `${color}08` }}>
        ...
        <div className="text-[8px] text-text-light italic">&ldquo;Moro aqui há 5 anos e a gestão atual transformou o condomínio. Parabéns a todos!&rdquo;</div>
        <div className="text-[7px] text-text-muted mt-1">— Ana Paula, Apt 405</div>
      </div>
      {[
        ...
        <div key={i} className="flex items-center gap-2 p-2 rounded-xl border border-border mb-1.5">
          <span className="text-sm">{item.icon}</span>
          <div>
            <div className="text-[9px] font-bold text-text">{item.nome}</div>
            <div className="text-[7px] text-text-muted">{item.autor}</div>
          </div>
        </div>
      ))}
    </div>
...
function MockMural({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">📌 Mural de Recados</div>
      {[
        ...
        <div key={i} className="p-3 rounded-xl border border-border mb-2">
          <div className="flex items-center gap-2 mb-1.5">
            ...
            <div>
              <div className="text-[9px] font-bold text-text">{msg.autor}</div>
              <div className="text-[7px] text-text-muted">{msg.tempo} atrás</div>
            </div>
          </div>
          <div className="text-[8px] text-text-light leading-relaxed">{msg.texto}</div>
...
function MockParceiros({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🤝 Parceiros do Condomínio</div>
      {[
        ...
        <div key={i} className="p-2.5 rounded-xl border border-border mb-2">
          ...
          <div className="text-[8px] text-text-light">🎁 {p.beneficio}</div>
        </div>
      ))}
    </div>
  );
...
function MockCaronas({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🚗 Caronas Coletivas</div>
      <div className="h-24 rounded-xl bg-[#E8F4FD] mb-3 flex items-center justify-center">
        <div className="text-center">
          <span className="text-2xl">🗺️</span>
          <div className="text-[7px] text-text-light mt-0.5">Mapa de rotas</div>
        </div>
      </div>
      {[
        ...
        <div key={i} className="p-2.5 rounded-xl border border-border mb-2 flex items-center gap-2">
          ...
          <div className="flex-1">
            <div className="text-[9px] font-bold text-text">{c.destino}</div>
            <div className="text-[7px] text-text-muted">{c.motorista} · {c.horario}</div>
          </div>
          <div className="text-center">
            <div className="text-[10px] font-bold" style={{ color }}>{c.vagas}</div>
            <div className="text-[6px] text-text-muted">vagas</div>
          </div>
        </div>
      ))}
    </div>
...
function MockAquisicoes({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🛒 Novas Aquisições</div>
      {[
        ...
        <div key={i} className="flex items-center gap-2.5 p-2.5 rounded-xl border border-border mb-2">
          ...
          <div className="flex-1">
            <div className="text-[9px] font-bold text-text">{a.item}</div>
            <div className="text-[7px] text-text-muted">{a.data} · {a.valor}</div>
          </div>
        </div>
      ))}
...
function MockRealizacoes({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🏆 Nossas Realizações</div>
      {[
...
function MockSemanaCondominio({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">📅 Semana do Condomínio</div>
      {[
        ...
        <div key={i} className="flex items-center gap-2 p-2 rounded-lg border-b border-[#F1F5F9]">
          ...
          <div className="text-[8px] text-text-light">{d.ativ}</div>
        </div>
      ))}
    </div>
  );
...
function MockConhecaSindico({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">👤 Conheça o Síndico</div>
      <div className="flex flex-col items-center mb-3">
        ...
        <div className="text-[11px] font-bold text-text">Ricardo Mendes</div>
        <div className="text-[8px] text-text-muted">Síndico desde 2024 · Morador há 12 anos</div>
      </div>
      <div className="p-3 rounded-xl mb-3" style={{ backgroundColor: `${color}08` }}>
        <div className="text-[8px] text-text-light italic leading-relaxed">
      ...
      <div className="space-y-1.5">
        <div className="flex items-center gap-2 text-[8px] text-text-light">🏢 Atendimento: Terça e Quinta, 18h às 20h</div>
        <div className="flex items-center gap-2 text-[8px] text-text-light">📧 sindico@jardimdasflores.com.br</div>
        <div className="flex items-center gap-2 text-[8px] text-text-light">📱 (11) 99999-0001</div>
      </div>
    </div>
  );
}
...
function MockBenfeitorias({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">⭐ Benfeitorias Realizadas</div>
      {[
        ...
        <div key={i} className="flex items-center gap-2 p-2 rounded-lg border border-border mb-1.5">
          ...
          <div className="flex-1">
            <div className="text-[8px] font-bold text-text">{b.texto}</div>
            <div className="text-[7px] text-text-muted">{b.data}</div>
          </div>
...
function MockLinks({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🔗 Links Úteis</div>
      {[
        ...
        <div key={i} className="flex items-center gap-2.5 p-2.5 rounded-xl border border-border mb-2">
          ...
          <div className="flex-1">
            <div className="text-[9px] font-bold text-text">{link.nome}</div>
            <div className="text-[7px] text-text-muted">{link.desc}</div>
          </div>
    ...
    <div className="p-4">
      <div className="rounded-xl overflow-hidden border-2" style={{ borderColor: `${color}44` }}>
        ...
        <div className="p-3 bg-white">
          <div className="text-[9px] font-bold text-text mb-2">Nesta Edição:</div>
          {['Reforma da piscina: 75% concluída', 'Balanço financeiro positivo', 'Nova academia inaugurada', 'Feira de trocas dia 15/03'].map((item, i) => (
            <div key={i} className="flex items-center gap-1.5 mb-1">
              ...
              <div className="text-[8px] text-text-light">{item}</div>
            </div>
          ))}
        </div>
      </div>
...
function MockAvaliacoes({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">⭐ Avaliações</div>
      {[
        ...
        <div key={i} className="p-3 rounded-xl border border-border mb-2">
          <div className="text-[9px] font-bold text-text mb-1.5">{av.pergunta}</div>
          <div className="flex gap-0.5 mb-1">
            {[...Array(10)].map((_, j) => (
              <div key={j} className={`w-5 h-5 rounded-md flex items-center justify-center text-[7px] font-bold ${j < Math.round(av.media) ? 'text-white' : 'text-[#CBD5E1] border border-border'}`}
                style={j < Math.round(av.media) ? { backgroundColor: color } : {}}>
                {j + 1}
              </div>
            ))}
          </div>
          <div className="text-[7px] text-text-muted">Média: <span className="font-bold" style={{ color }}>{av.media}</span> · {av.votos} votos</div>
        </div>
      ))}
    </div>
  );
...
function MockTelefones({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">📞 Telefones Úteis</div>
      {[
        ...
        <div key={i} className="flex items-center justify-between p-2 rounded-xl border border-border mb-1.5">
          <div className="flex items-center gap-2">
            <span className="text-sm">{t.icon}</span>
            <div className="text-[9px] font-bold text-text">{t.nome}</div>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="text-[8px] text-text-light">{t.tel}</span>
...
function MockQRCode({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">📱 QR Codes do Condomínio</div>
      {[
        ...
        <div key={i} className="flex items-center gap-3 p-3 rounded-xl border border-border mb-2">
          <div className="w-12 h-12 rounded-lg border border-border flex items-center justify-center" style={{ backgroundColor: `${color}06` }}>
          ...
          <div>
            <div className="text-[9px] font-bold text-text">{qr.titulo}</div>
            <div className="text-[7px] text-text-muted">{qr.desc}</div>
          </div>
        </div>
      ))}
    </div>
...
function MockBoasVindas({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🎉 Boas-Vindas!</div>
      <div className="p-3 rounded-xl mb-3" style={{ background: `linear-gradient(135deg, ${color}15, ${color}05)` }}>
        <div className="text-[9px] text-text-light leading-relaxed">
      ...
      {[
        ...
        <div key={i} className="flex items-center gap-3 p-2.5 rounded-xl border border-border mb-2">
          ...
          <div>
            <div className="text-[9px] font-bold text-text">{m.nome}</div>
            <div className="text-[7px] text-text-muted">{m.apto} · {m.data}</div>
          </div>
...
function MockAgendamentoMudancas({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🚚 Agendamento de Mudanças</div>
      <div className="p-2.5 rounded-xl mb-3" style={{ backgroundColor: `${color}08` }}>
        ...
        <div className="text-[8px] text-text-light leading-relaxed">
      ...
      <div className="text-[9px] font-bold text-text mb-2">Próximas Mudanças</div>
      {[
        ...
        <div key={i} className="flex items-center gap-2 mb-2 p-2 rounded-lg border border-border">
          ...
          <div className="text-[8px] text-text-light">{m.info}</div>
        </div>
      ))}
    </div>
  );
...
function MockAgendamentoReformas({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">🔨 Agendamento de Reformas</div>
      <div className="p-2.5 rounded-xl mb-3" style={{ backgroundColor: `${color}08` }}>
      ...
      <div className="text-[9px] font-bold text-text mb-2">Reformas em Andamento</div>
      {[
        ...
        <div key={i} className="flex items-center gap-2 mb-2 p-2 rounded-lg border border-border">
          ...
          <div className="flex-1">
            <div className="text-[8px] font-bold text-text">{r.apto} — {r.tipo}</div>
            <div className="text-[7px] text-text-muted">{r.prazo}</div>
          </div>
...
function MockFuncionarios({ color }: { color: string }) {
  return (
    <div className="p-4">
      <div className="text-[11px] font-bold text-text mb-3">👷 Gestão de Funcionários</div>
      <div className="grid grid-cols-2 gap-1.5 mb-3">
        {[
          ...
          <div key={i} className="p-2 rounded-lg border border-border text-center">
            ...
            <div className="text-[7px] text-text-muted">{s.label}</div>
          </div>
        ))}
      </div>
      {[
        ...
        <div key={i} className="flex items-center gap-2 mb-2 p-2 rounded-lg border border-border">
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[9px] font-bold text-text truncate">{e.tarefa}</div>
            <div className="text-[7px] text-text-muted">{e.nome} · {e.cargo}</div>
          </div>
    ...
    >
      ...
      >
        ...
        <PhoneFrame color={categoryColor}>
          <div className="px-4 py-2.5 flex items-center gap-2 border-b border-border" style={{ backgroundColor: `${categoryColor}08` }}>
            ...
            <div>
              <div className="text-[9px] font-bold text-text">Residencial Jardim das Flores</div>
              <div className="text-[7px] text-text-muted">Edição #3 · Março 2026</div>
            </div>
          </div>
          {renderMockup ? renderMockup(categoryColor) : (
            <div className="p-4 text-center text-[10px] text-text-muted">Prévia não disponível</div>
          )}
        </PhoneFrame>
      </motion.div>
    </motion.div>
